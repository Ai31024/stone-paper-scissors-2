jQuery(function () {
  ...
  // calling audio files
  const winGameAudio = new Audio("./audio/win_game_sfx.mp3");
  const loseGameAudio = new Audio("./audio/lose_game_sfx.mp3");
  const drawGameAudio = new Audio("./audio/draw_game_sfx.mp3");

  // setting effect files
  const win_game_effect = "./image/effects/win_gif.gif";
  const lose_game_effect = "./image/effects/lose_gif.gif";
  const draw_game_effect = "./image/effects/draw_gif.gif";

  // setting props files
  const stone_prop = "./image/props/stone.png";
  const paper_prop = "./image/props/paper.png";
  const scissor_prop = "./image/props/scissor.png";
